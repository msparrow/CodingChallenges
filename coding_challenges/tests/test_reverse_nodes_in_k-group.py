...
@pytest.mark.parametrize("head, k, expected", [
    ...
    (ListNode(1), 1, [1]),
    (ListNode(1, ListNode(2)), 2, [2, 1]),
    (ListNode(1, ListNode(2, ListNode(3))), 2, [2, 1, 3]),
    (ListNode(1, ListNode(2, ListNode(3))), 3, [3, 2, 1]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4)))), 2, [2, 1, 4, 3]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4)))), 3, [3, 2, 1, 4]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4)))), 4, [4, 3, 2, 1]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5))))), 2, [2, 1, 4, 3, 5]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5))))), 3, [3, 2, 1, 4, 5]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5))))), 4, [4, 3, 2, 1, 5]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5))))), 5, [5, 4, 3, 2, 1]),
    (ListNode(1, ListNode(2, ListNode(3, ListNode(4, ListNode(5))))), 1, [1, 2, 3, 4, 5]),
    (None, 1, [])
])
